                ...
                <div class="col-xxl-7 col-xl-9 col-lg-6 col-md-6 col-sm-8 col-12">
                    <div class="bd-authentication-form-wrapper">
                        <div class="bd-authentication-form-logo">
                            <a href="{{ route('home') }}"><img src="{{ asset(get_config()->logo) }}" width="120px"
                                    height="120px" alt="logo"></a>
                        </div>
                        ...
                        <form class="needs-validation" action="{{ route('register') }}" method="POST">
                            ...
                            <div class="form-input-box mb-20">
                                <div class="form-input-title">
                                    <label for="emailAddress">Tên của bạn <span>*</span></label>
                                </div>
                                <input class="form-control @error('name') is-invalid @enderror" id="name"
                                    type="name" name="name" placeholder="Tên của bạn" value="{{ old('name') }}">
                        ...
                        <div class="bd-sign-up-label underline-two text-center pt-3">
                            Bạn không có tài khoản?<a href="{{ route('login') }}" class="sign-link"> Đăng nhập</a>
                        </div>
