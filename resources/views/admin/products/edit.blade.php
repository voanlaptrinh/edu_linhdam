...
@section('content')
    ...
    <div class="container">
        ...
        <!-- row -->
        <form class="row" action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data" novalidate>
            @csrf
                    @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-lg-12">
                                ...
                                <input type="text" name="title" class="form-control" id="title"
                                    placeholder="Tiêu đề sản phẩm" value="{{ old('title', $product->title) }}" required />
                                @error('title')
                            ...
                            <div class="mb-3 col-lg-6">
                                ...
                                <input type="text" class="form-control" id="author" name="author"
                                    placeholder="Tác giả" value="{{ old('author', $product->author) }}">
                                @error('author')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-3 col-lg-6">
                                ...
                                <input type="number" min="0" class="form-control" name="quantity"
                                    placeholder="Số lượng" value="{{ old('quantity', $product->quantity) }}">
                                @error('quantity')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3 col-lg-6">
                                ...
                                <input type="text" class="form-control" id="isbn" name="isbn"
                                    placeholder="Mã ISBD" value="{{ old('isbn', $product->isbn) }}">
                                @error('isbn')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3 col-lg-12 mt-5">
                                ...
                                <textarea class="w-100" id="tyni" name="description">{{ old('description', $product->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="card-body p-6">
                        <div class="d-flex flex-column flex-md-row align-items-center mb-4 file-input-wrapper gap-2">
                            ...
                            @if ($product->cover_image)
                                <div id="current-cover-image">
                                    <img src="{{ asset($product->cover_image) }}" alt="Current Cover Image"
                                        id="cover-preview"  class="image avatar avatar-lg rounded-3">
                                </div>
                            @endif
                            ...
                            <div class="file-upload btn btn-light ms-md-4">
                                ...
                                <span>Upload Ảnh bìa sách</span>
                            </div>
                            <span class="ms-2 text-muted">JPG, GIF or PNG. 1MB Max.</span>
                    ...
                    <div class="card-body p-6">
                        <div class="mb-3">
                            ...
                            <input 
                                name="tags" 
                                id="tags"
                                value="{{ old('tags', json_encode($product->tags ?? [])) }}"
                                class="w-100" 
                                placeholder="Tags" 
                                required />
                            @error('tags')
                    ...
                    <div class="card-body p-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" min="0" name="sale_price" class="form-control"
                                placeholder="$0.00" value="{{ old('sale_price', $product->sale_price) }}">
                            @error('sale_price')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="card mb-6 card-lg">
                    <div class="card-body p-6">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" rows="3" name="metadescription" placeholder="Mô tả Seo">{{ old('metadescription', $product->metadescription) }}</textarea>
