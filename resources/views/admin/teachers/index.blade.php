        ...
        <div class="row mb-8">
            <div class="col-md-12">
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-4">
                    ...
                    <div>
                        <a href="{{ route('teacher.create') }}" class="btn btn-primary">Thêm mới Giáo viên</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-xl-12 col-12 mb-5">
                <div class="card h-100 card-lg">
                    ...
                    <div class="card h-100 card-lg">
                        <div class="px-6 py-6">
                            <form method="GET" action="{{ route('teacher.admin') }}">
                                <div class="row g-5">
                                    <!-- form -->
                                    <div class="col-lg-8 col-md-8 col-12">
                             
                                            <input class="form-control" name="search" type="search"
                                                placeholder="Tìm kiếm tên giáo viên" value="{{ request()->input('search') }}"
                                                aria-label="Search">
